...
RUN PowerShell -File C:\Software\VS2022.install.ps1 C:\Software\VS2022.vsconfig
...
CMD ["cmd.exe", "/K", "%ProgramFiles(x86)%\\Microsoft Visual Studio\\2022\\Professional\\Common7\\Tools\\VsDevCmd.bat"]